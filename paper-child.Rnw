...
p1 <- ggplot(data = probsDat,
  ...
  ThemeNoNet + 
  theme(panel.grid = element_blank(), axis.text = element_text(size=rel(.7)),
        legend.position = "bottom", legend.title = element_text(size=rel(.7))) +
  coord_fixed() + 
