...
<<sigtesting, fig.show = 'hold', out.width='\\textwidth', fig.height=3, fig.cap="Significant effects for the two data sets, at the level of 0.10 as calculated by the Wald-type test available in the SIENA software.">>=
