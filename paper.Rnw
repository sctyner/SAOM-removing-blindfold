...
require(knitr)
opts_chunk$set(fig.path='figure/', cache.path='cache/', fig.align='center', fig.pos='h', fig.width=5, fig.height=5, par=TRUE, cache=TRUE, concordance=TRUE, autodep=TRUE, message=F, warning=F, echo = FALSE, root.dir = "~/Desktop/Dissertation - LETS GO/SAOM-removing-blindfold/")
@
...
Unlike other network models, SAOMs are not very well understood. \st{They are relatively new, especially compared to the classic exponential random graph models, and they are not very tractable analytically with traditional methods. Likelihood functions turn into very complex objects due to the dependency structure inherent in the data. Therefore, computationally more tractable solutions are used to fit estimators, in particular, % Traditional modeling steps, like determining the likelihood function, are very complex. Because of this, 
...
set.seed(823746)
.libPaths(new = c("/Library/Frameworks/R.framework/Versions/3.4/Resources/library", "/Library/Frameworks/R.framework/Versions/3.4/Resources/oldpkgs/"))
