...
\if0\blind
{
  \title{\bf Visual Diagnostics of Dynamic Social Network Models}
...
\if1\blind
{
  ...
  \bigskip
  \begin{center}
    {\LARGE\bf Visual Diagnostics of Dynamic Social Network Models}
\end{center}
  \medskip
} \fi
